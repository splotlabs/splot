...
`unsupported_cfl_intra`: the runtime now accepts the conformant 10-bit sequence
header far enough to reach the next unsupported sequence-tool gate before any
