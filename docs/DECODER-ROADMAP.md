...
`do_uneven_4way_partition`, and § 8.2 copy/average policy metadata, and then
stops at structured `decode/unsupported-feature` metadata for the unimplemented
...
actual partition syntax reads or decisions, recursive
