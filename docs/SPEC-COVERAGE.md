...
Matrix version 1. Last reviewed 2026-06-15. 445 feature(s); 390 cite a spec section.
...
55 feature(s) track conformance, encoder, CLI, automation, or documentation work with no single spec section; see [FEATURE-STATUS.md](./FEATURE-STATUS.md):
