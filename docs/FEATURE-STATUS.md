...
Matrix version 1. Last reviewed 2026-06-13. 154 feature(s).
...
| `AV2-6.2.2-OBU-HEADER-ACTIVATED-SEQUENCE-LIMITS` | OBU header layer ids constrained by activated sequence header | normative | validator-check | done | done | done | partial | todo | todo | partial | done | pending | `crates/splot-validate/src/context` |
