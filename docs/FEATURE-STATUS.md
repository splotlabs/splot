...
Matrix version 1. Last reviewed 2026-06-10. 134 feature(s).
...
| `AV2-6.2.2-OBU-HEADER-ACTIVATED-SEQUENCE-LIMITS` | OBU header layer ids constrained by activated sequence header | normative | validator-check | done | done | done | partial | todo | todo | partial | done | pending | `crates/splot-validate/src/context.rs` |
...
| `AV2-7.3.4-CODED-NONOUTPUT-FRAME-UNIT` | Coded nonoutput frame unit ordering semantics | normative | bitstream-semantics | done | done | n/a | partial | n/a | n/a | partial | done | pending | `crates/splot-validate/src/context.rs` |
| `AV2-7.3.5-CODED-FRAME-UNIT` | Coded frame unit ordering semantics | normative | bitstream-semantics | done | done | n/a | partial | n/a | n/a | partial | done | pending | `crates/splot-validate/src/context.rs` |
...
| `CONF-AVM-DIFF-HARNESS` | AVM differential testing harness | conformance | conformance | partial | todo | n/a | n/a | n/a | n/a | todo | todo | todo | `xtask/src/main.rs` |
...
| `CONF-AVM-VALID-STREAMS` | AVM valid stream conformance | conformance | conformance | todo | todo | n/a | n/a | n/a | n/a | todo | todo | todo | `xtask/src/main.rs` |
