...
| `AV2-5.17.3-METADATA-GROUP` | Metadata group OBU syntax | normative | bitstream-syntax | done | done | done | partial | todo | todo | done | done | pending | `crates/splot-core/src/headers/metadata.rs` |
...
| `AV2-5.17.10-METADATA-SCAN-TYPE` | Scan type metadata syntax | normative | bitstream-syntax | done | done | done | partial | todo | todo | done | done | pending | `crates/splot-core/src/headers/metadata.rs` |
