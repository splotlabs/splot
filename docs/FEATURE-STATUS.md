...
| `AV2-7.3.6-CODED-EXTENDED-LAYER-UNIT` | Coded extended layer unit ordering semantics | normative | bitstream-semantics | done | todo | n/a | partial | n/a | n/a | todo | todo | pending | `crates/splot-validate/src/context.rs` |
