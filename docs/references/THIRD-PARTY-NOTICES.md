...
Known exception: OpenSpec-generated assistant integration files under
`.claude/commands/opsx/`, `.claude/skills/openspec-*`, `.codex/skills/openspec-*`,
`.github/prompts/opsx-*`, and `.github/skills/openspec-*` are MIT-licensed
tooling artifacts generated by OpenSpec. Keep them isolated to those paths and
preserve generated license metadata when present.
