...
Runtime frame-header conformance errors use `source_issue_kind: frame_header_conformance_error`; the primary-reference relationship check preserves its AV2 § 6 attribution and frame-header byte offset.
