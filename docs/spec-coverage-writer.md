...
Matrix version 1. Last reviewed 2026-06-15. 99 writable feature(s).
...
| 5.4, 5.2.2, 5.2.3, B.2 | `ENC-SEQUENCE-HEADER-OBU` | Encoder minimal-intra sequence-header OBU | done | `crates/splot-core/src/headers/frame/encoder_input.rs` |
...
| 5.5, 5.2.2, B.2 | `ENC-TEMPORAL-DELIMITER-OBU` | Encoder temporal-delimiter OBU primitive | done | `crates/splot-core/src/headers/frame/encoder_input.rs` |
...
| 5.18.2, 5.19, 5.2.2, Annex B | `ENC-MINIMAL-CLK-BASE-Q-IDX` | base_q_idx-parameterized minimal CLK container | done | `crates/splot-core/src/headers/frame/encoder_input.rs` |
...
| 5.19, 5.20.1 | `ENC-MINIMAL-INTRA-TILE-GROUP-OBU` | Encoder writer-input minimal-intra tile-group OBU payload assembler | done | `crates/splot-core/src/headers/frame/encoder_input.rs` |
