...
//! registry from `docs/DIAGNOSTICS.md`.
//!
...
const DOC_REL: &str = "docs/DIAGNOSTICS.md";
...
const BEGIN_MARKER: &str = "<!-- validator-diagnostics-registry:begin -->";
const END_MARKER: &str = "<!-- validator-diagnostics-registry:end -->";
...
fn render_generated(entries: &[Entry]) -> String {
    ...
    out.push_str(
        "//! @generated by `cargo xtask gen-explain` from docs/DIAGNOSTICS.md — DO NOT EDIT.\n",
    );
