...
const COVERAGE_ROWS: &[CoverageRow] = &[
    ...
    CoverageRow {
        ...
        local_reference_evidence: &[],
        diagnostics: &["decode/unsupported-feature"],
        notes: "Some scalar intra prediction and workspace primitives exist, including subsampled DC, H/V cardinal directional prediction, and no-panic fuzz coverage over bounded structured direct prediction and current-frame workspace cases. General directional angles, full edge preparation, data-driven, IBP, full CfL/MHCCP, palette, all inter prediction, and broad runtime integration remain unsupported.",
    },
    CoverageRow {
