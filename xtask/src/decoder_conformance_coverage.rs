...
const COVERAGE_ROWS: &[CoverageRow] = &[
    ...
    CoverageRow {
        ...
        local_reference_evidence: &[],
        diagnostics: &["decode/unsupported-feature"],
        notes: "Generated table plumbing exists for committed table sources, including the TxSize enum-valued `Adjusted_Tx_Size`, `Tx_Size_Sqr`, and `Tx_Size_Sqr_Up` conversion tables. Many transform, quant-matrix, warp/filter, and restoration consumers are still not wired into runtime decode.",
    },
    CoverageRow {
