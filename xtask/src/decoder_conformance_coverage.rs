...
const COVERAGE_ROWS: &[CoverageRow] = &[
    CoverageRow {
        ...
        decoder_support_rows: &["decode-byte-stream-planner", "symbol-decoder"],
        feature_ids: &["DECODE-BYTE-STREAM-PLANNER", "AV2-8.2-SYMBOL-DECODER"],
        status: "partial",
        tests: &["cargo test -p splot-core bitio --locked"],
        fuzz_targets: &["parse_obu", "decode_plan_bytes"],
    ...
    CoverageRow {
        ...
        implementation_owner: "splot-core stream parsing and splot-decode byte planner",
        decoder_support_rows: &["decode-byte-stream-planner", "cli-decode-entrypoint"],
        feature_ids: &["DECODE-BYTE-STREAM-PLANNER", "CLI-DECODE"],
        status: "partial",
        tests: &[
        ...
        fuzz_targets: &["parse_obu", "parse_bitstream", "decode_plan_bytes"],
        local_reference_evidence: &[],
        diagnostics: &[
        ...
        notes: "Input traversal and malformed-source diagnostics exist. Runtime decode remains intentionally unsupported after planning succeeds.",
    },
    CoverageRow {
        ...
        decoder_support_rows: &["decode-stream-state", "minimal-decode-tier-contract"],
        feature_ids: &[
        ...
        fuzz_targets: &["validate_bytes", "decode_plan_bytes"],
        local_reference_evidence: &[],
        diagnostics: &["decode/unsupported-feature"],
        notes: "Parser and validator coverage exists for many syntax structures, but runtime decoder consumption, external-HLS handling, metadata effects, film-grain state, and operating-point behavior are incomplete.",
    },
    CoverageRow {
        ...
        notes: "Frame-header parsing and tile input derivation are partial. Full runtime frame state, inter paths, filters, global motion, segmentation, quantization, and film-grain config consumption are not yet runtime decoded.",
    },
    CoverageRow {
        ...
        status: "partial",
        tests: &["cargo test -p splot-decode tile_payload --locked"],
    ...
    CoverageRow {
        ...
        decoder_support_rows: &["cli-decode-entrypoint", "decode-stream-state"],
    ...
    CoverageRow {
        ...
        status: "partial",
        tests: &["cargo test -p splot-recon intra --locked"],
        fuzz_targets: &[],
        local_reference_evidence: &[],
        diagnostics: &["decode/unsupported-feature"],
        notes: "Some scalar intra prediction primitives exist. Directional, data-driven, IBP, CfL/MHCCP, palette, all inter prediction, and runtime integration remain unsupported.",
    },
    CoverageRow {
    ...
    CoverageRow {
        ...
        decoder_support_rows: &["symbol-decoder", "tile-cdf-selection-boundary"],
        feature_ids: &[
            "AV2-8.2-SYMBOL-DECODER",
            "DECODE-TILE-CDF-SELECTION-BOUNDARY",
        ],
