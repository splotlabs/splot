...
- [x] 2.1 Update the minimal runtime ac0ej3 diagnostic expectation so the live
      stream no longer reports `unsupported_wienerns_filter`.
- [x] 2.2 Add parser tests for the ac0ej3 luma two-class bank shape, a
...
- [x] 3.1 Add implementation-matrix and decoder-support rows for
      `DECODE-AC0EJ3-WIENERNS-BANK-FRONTIER`, and update adjacent ac0ej3 notes.
