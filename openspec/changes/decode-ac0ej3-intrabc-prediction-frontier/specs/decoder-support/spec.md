...
checked luma current-frame prediction geometry, including the source sample
envelope and subpel phase, from the retained §5.20.7.13 and §5.20.7.20 block
vector, and SHALL continue to mark decoded sample population, loop-restoration
