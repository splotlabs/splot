...
bounded IntrABC mode-info and prediction-geometry handoff for the local ac0ej3
...
The decoder SHALL NOT treat IntrABC prediction-geometry handoff in the ac0ej3
...
equality, and successful ac0ej3 decode SHALL remain unclaimed until separately
