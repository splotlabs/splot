...
| `frame-unit-segmentation` | `AV2-7.3.3-CODED-OUTPUT-FRAME-UNIT`, `AV2-7.3.4-CODED-NONOUTPUT-FRAME-UNIT`, `AV2-7.3.5-CODED-FRAME-UNIT`, `AV2-7.3.7-TEMPORAL-UNIT-ORDER`, `AV2-5.13-QUANTIZATION-MATRIX`, `AV2-5.14-FILM-GRAIN`, `AV2-5.17.5-METADATA-HDR-CLL`, `AV2-5.17.6-METADATA-HDR-MDCV`, `AV2-7.3.8-HLS-AVAILABILITY` (§7.3.8.10 CI placement), `AV2-5.5-TEMPORAL-DELIMITER` (groundwork note) | in progress |
