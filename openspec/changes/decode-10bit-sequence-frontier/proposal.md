...
- CLI/docs/tests: local `local decoder mission` diagnostic regression, 10-bit fixture regression, implementation matrix, generated status/coverage docs.
...
- [ ] The local `local-decoder-mission.ivf` regression advances past the sequence bit-depth gate and reaches the next precise fail-closed gate.
