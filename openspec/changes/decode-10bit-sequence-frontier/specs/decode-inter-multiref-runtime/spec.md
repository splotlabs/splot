...
#### Scenario: local decoder mission reaches the next parse-only runtime gate

- **WHEN** `splot decode /Users/bartosztomczyk/Documents/SplotLabs/local-decoder-mission.ivf` runs with default decode limits
...
- **AND** the diagnostic tracks `DECODE-10BIT-SEQUENCE-FRONTIER`
