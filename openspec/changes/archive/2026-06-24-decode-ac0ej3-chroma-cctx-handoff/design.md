...
- Advance the local `ac0ej3.ivf` probe to the next structured unsupported frontier without producing output.
...
- Do not claim bit-exact `ac0ej3.ivf` decode against AVM/dav2d.
