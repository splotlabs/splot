...
The ac0ej3 decode path currently reaches AV2 §7.20.4 classified-Wiener coordinate
...
Feature ID: `DECODE-AC0EJ3-LR-CLASSIFIED-WIENER-VALUES`.

## What Changes

- Add a tracked ac0ej3 decoder frontier for value-backed classified-Wiener
  classification.
...
- Retain a fail-closed live ac0ej3 diagnostic that names the remaining missing
...
- Non-goals: no broad AV2 decode, no loop-restoration filtering, no chroma Wiener
  ...
  equality claim for ac0ej3.

## Capabilities

### New Capabilities

- `ac0ej3-lr-classified-wiener-values`: Tracks the fail-closed runtime frontier
