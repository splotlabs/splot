...
- [x] 1.1 Add `DECODE-LR-LIVE-TX-SKIP-GRID` constants and live
...
- [x] 2.2 Keep the live local decoder mission diagnostic fail-closed and update focused CLI
...
- [x] 3.1 Add the implementation matrix row, decoder support row, and generated
  support/status updates for `lr-live-tx-skip-grid`.
