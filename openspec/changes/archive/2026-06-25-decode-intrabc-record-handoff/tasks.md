...
- [x] 1.1 Add a bounded IntrABC mode-info helper for the local decoder mission selectable-transform path that consumes observed AV2 §5.20.5.3 `use_intrabc` and §5.20.5.4 `read_intrabc_info()` syntax in order.
...
- [x] 2.3 Update the ignored local decoder mission CLI probe expectation to the next structured unsupported-feature frontier reached after IntrABC syntax consumption.
