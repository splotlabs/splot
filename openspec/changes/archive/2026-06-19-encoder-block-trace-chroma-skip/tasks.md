...
- [x] 1.3 Route the U `txb_skip` (`DEFAULT_TXB_SKIP_CDF[..][0][..][6]`, the same `is_inter||fsc_mode` bank as luma, ctx 6) and V `txb_skip` (`DEFAULT_V_TXB_SKIP_CDF[..][0]`) rows through the unified §8.2 roundtrip.
