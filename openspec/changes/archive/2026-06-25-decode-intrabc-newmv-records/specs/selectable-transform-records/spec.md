...
### Requirement: local decoder mission selectable-transform IntrABC mode-info handoff

The decoder SHALL consume the observed AV2 §5.20.5.3 `use_intrabc = 1`
mode-info path and the bounded §5.20.5.4 IntrABC syntax in the local decoder mission
