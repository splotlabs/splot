...
- [x] 2.1 Add `DECODE-LR-LIVE-STORAGE-ALLOCATION` constants and diagnostic reason.
- [x] 2.2 Move the live local decoder mission failure from runtime storage-retention to live storage-allocation after shell allocation succeeds.
- [x] 2.3 Update the ignored local decoder mission CLI gate test to expect the new Feature ID, matrix row, reason, and diagnostic message.
