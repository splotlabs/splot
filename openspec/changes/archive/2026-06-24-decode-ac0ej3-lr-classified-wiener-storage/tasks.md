...
- [x] 1.1 Add `DECODE-AC0EJ3-LR-CLASSIFIED-WIENER-STORAGE` to `docs/IMPLEMENTATION-MATRIX.toml`.
...
- [x] 2.3 Update the live ac0ej3 runtime diagnostic to reference the storage frontier without claiming filtering/output.
