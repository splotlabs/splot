...
- [x] 1.1 Add `DECODE-LR-CLASSIFIED-WIENER-VALUES` to `docs/IMPLEMENTATION-MATRIX.toml`.
...
- [x] 2.2 Update the live local decoder mission runtime diagnostic to report the new storage boundary without claiming real frame or `LrTxSkip` reads.
