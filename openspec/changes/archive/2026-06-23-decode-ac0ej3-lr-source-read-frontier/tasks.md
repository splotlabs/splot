...
- [x] 2.3 Move the live ac0ej3 runtime diagnostic from the source-bounds frontier to the classified-Wiener boundary that precedes source reads for its two-class luma bank.
