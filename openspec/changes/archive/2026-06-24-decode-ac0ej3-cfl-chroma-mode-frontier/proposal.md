...
The local ac0ej3 mission stream now reaches live Wiener NS LR transform-record
...
- Add Feature ID `DECODE-AC0EJ3-CFL-CHROMA-MODE-FRONTIER` for the active CfL
...
- Thread the CfL chroma mode value through the ac0ej3 selectable-transform
...
### New Capabilities
- `ac0ej3-cfl-chroma-mode-frontier`: active CfL chroma mode and alpha syntax
  consumption for the local ac0ej3 live transform-record frontier.

### Modified Capabilities
- `ac0ej3-selectable-transform-records`: clarify that selectable record
...
- No new crate dependencies, no CLI behavior change, no AVM/dav2d invocation,
  and no successful ac0ej3 decode/output claim.
