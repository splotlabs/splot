...
- [x] 1.1 Re-run the live `local-decoder-mission.ivf` decode probe and capture the current structured unsupported diagnostic.
...
- [x] 3.2 Re-run the live `local-decoder-mission.ivf` probe and focused tests.
