...
`DECODE-AC0EJ3-LR-TX-SKIP-GRID-RETENTION` proves a decoder-local dense
`WienerNsLrTxSkipGrid` from caller-provided transform records. The live ac0ej3
...
- Add `DECODE-AC0EJ3-LR-LIVE-TX-SKIP-GRID` as a distinct partial ac0ej3 LR
  feature.
...
- Keep tests focused on exact population, guard behavior, and the live ac0ej3
...
- [Risk] This is still a prerequisite brick and does not make ac0ej3 decode.
