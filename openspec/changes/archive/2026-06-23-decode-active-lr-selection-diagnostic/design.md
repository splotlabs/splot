...
`DECODE-LR-UNIT-SELECTIONS-FRONTIER` extended the supported LR syntax
frontier from aggregate active/inactive counts to a syntax-ordered per-unit
selection list. The runtime still rejects the local decoder mission stream at byte offset
