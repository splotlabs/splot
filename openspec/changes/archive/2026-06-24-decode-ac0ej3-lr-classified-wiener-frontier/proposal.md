...
The local ac0ej3 stream now stops at the §7.20.4 pixel-classified Wiener gate
...
- Add Feature ID `DECODE-AC0EJ3-LR-CLASSIFIED-WIENER-FRONTIER` for the narrow
...
- `ac0ej3-lr-classified-wiener-frontier`: track the ac0ej3 classified-Wiener
  dependency frontier and its fail-closed diagnostic.

### Modified Capabilities

- `decoder-support`: move the live ac0ej3 runtime diagnostic from the generic
