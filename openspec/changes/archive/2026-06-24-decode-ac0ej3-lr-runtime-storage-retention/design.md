...
- Update the live ac0ej3 diagnostic and support docs to name the new boundary.
...
2. Retain storage shape and byte budgets, not sample values.
   - Rationale: ac0ej3 still lacks tile reconstruction into 10-bit current/CDEF frames and live transform-skip retention; using zero-filled buffers for classification would create confident wrong behavior.
