...
- [x] 1.1 Thread retained `fsc_mode` facts through the ac0ej3 selectable-transform record path without widening decoded sample support.
...
- [x] 2.3 Update the ignored local ac0ej3 CLI test expectation to the next structured unsupported-feature frontier.
