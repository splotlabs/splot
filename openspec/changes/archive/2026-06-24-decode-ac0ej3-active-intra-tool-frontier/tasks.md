...
- [x] 2.3 Update focused selectable/MRL tests and the local ac0ej3 CLI probe expectation to the new frontier.

## 3. Tracking and Verification

- [x] 3.1 Add `DECODE-AC0EJ3-ACTIVE-INTRA-TOOL-FRONTIER` matrix/support rows and regenerate status docs.
