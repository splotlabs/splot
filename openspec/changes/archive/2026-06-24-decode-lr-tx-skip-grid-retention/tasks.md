...
- [x] 1.2 Keep the live local decoder mission diagnostic fail-closed without claiming tile-populated grid values.
...
- [x] 2.2 Verify the local decoder mission diagnostic still reaches the current unsupported runtime gate.

## 3. Tracking And Validation

- [x] 3.1 Add `DECODE-LR-TX-SKIP-GRID-RETENTION` to the implementation matrix and decoder support matrix/status.
