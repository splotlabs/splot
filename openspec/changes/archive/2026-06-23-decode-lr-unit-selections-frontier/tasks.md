...
- [x] 1.1 Add `DECODE-LR-UNIT-SELECTIONS-FRONTIER` to the implementation matrix.
- [x] 1.2 Add decoder support/status coverage for `lr-unit-selections-frontier`.
...
- [x] 3.2 Run `openspec validate decode-lr-unit-selections-frontier --no-interactive`,
