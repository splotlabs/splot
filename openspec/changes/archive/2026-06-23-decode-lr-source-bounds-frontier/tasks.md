...
- [x] 1.1 Add `DECODE-LR-SOURCE-BOUNDS-FRONTIER` to the implementation matrix.
- [x] 1.2 Add decoder support/status coverage for `lr-source-bounds-frontier`.
...
- [x] 2.5 Move the live local decoder mission runtime diagnostic to the source-bounds frontier.
...
- [x] 3.2 Run `openspec validate decode-lr-source-bounds-frontier --no-interactive`,
