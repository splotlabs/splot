...
- Keep reconstruction, output, CCTX transforms, chroma output, and successful local decoder mission decode unsupported.

## Capabilities

### New Capabilities
- `chroma-cctx-handoff`: Covers the syntax-only CCTX metadata and chroma transform-type handoff needed by the live local decoder mission Wiener NS LR tx-skip record path.

### Modified Capabilities
- `decoder-support`: Adds the decoder support row and live local decoder mission frontier evidence for this handoff.
