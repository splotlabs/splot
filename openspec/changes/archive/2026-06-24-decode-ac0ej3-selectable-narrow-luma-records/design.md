...
The ac0ej3 runtime path now consumes active CfL mode-info syntax and reaches the
...
- Advance the live ac0ej3 fail-closed frontier to the next honest unsupported
...
- Add focused tests at the private transform-record layer rather than a public
  ...
  shape plus the live ac0ej3 diagnostic movement.
