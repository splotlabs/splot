...
the full plan is long hides those diagnostics and slows the local decoder mission.
...
- Pin the current `local-decoder-mission.ivf` diagnostic so future bricks can show concrete
