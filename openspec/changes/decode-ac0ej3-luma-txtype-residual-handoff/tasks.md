...
- [x] 2.2 Update the local ac0ej3 ignored CLI probe expectation to the next structured frontier.
- [x] 2.3 Update implementation matrix, decoder-support matrix, generated docs, and OpenSpec specs.

## 3. Validation

- [x] 3.1 Run the local `ac0ej3.ivf` probe and focused decode tests.
