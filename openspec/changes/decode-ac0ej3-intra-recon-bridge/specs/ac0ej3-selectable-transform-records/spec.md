...
### Requirement: ac0ej3 general-intra reconstruction bridge
...
subset of the ac0ej3 frame into a current-frame workspace. As the selectable
...
- **WHEN** the local ac0ej3 selectable transform-record walk runs with a
...
- **WHEN** `splot decode` is run on the local ac0ej3 fixture
...
- **THEN** every sample equals the committed AVM pre-filter reconstruction oracle
  ...
  oracle assertion — the first bit-exact ac0ej3 reconstruction milestone
