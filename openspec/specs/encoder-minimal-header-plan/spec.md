# encoder-minimal-header-plan Specification

## Purpose

Track the private minimal header-intent bridge from current encoder
configuration plus first-frame metadata to future sequence-header,
frame-header, and tile-group writer integration. The feature remains
non-emitting and private to `splot-encode`.
