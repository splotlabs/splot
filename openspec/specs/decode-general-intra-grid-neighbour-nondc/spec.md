# decode-general-intra-grid-neighbour-nondc Specification

## Purpose

Capture the completed OpenSpec requirements synchronized for `decode-general-intra-grid-neighbour-nondc`.
