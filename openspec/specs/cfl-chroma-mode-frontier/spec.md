# local decoder mission CfL Chroma Mode Frontier Specification

## Purpose
Define the fail-closed local decoder mission Wiener NS loop-restoration frontier that consumes
