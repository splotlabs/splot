# tile-partition-allowed-boundary Specification

## Purpose
Define the crate-private AV2 tile partition implied and allowed-set derivation
boundary that feeds future recursive partition traversal without claiming full
tile decoding.
