# ivf-container Specification

## Purpose

IVF/DKIF container support for AV2 streams in `splot-core`. IVF is treated as a
non-normative container around AV2 Annex B OBU payload bytes; AV2 syntax and
semantics still come from the AV2 specification.

Tracked by Feature IDs: `AV2-IVF-CONTAINER`.
