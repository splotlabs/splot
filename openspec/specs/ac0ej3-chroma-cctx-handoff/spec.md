# ac0ej3 Chroma CCTX Handoff Specification

## Purpose

Track the ac0ej3 decoder mission boundary where chroma CCTX and non-DCT
...
ac0ej3 Wiener NS LR tx-skip record path only when the caller selects the
...
The decoder SHALL allow the ac0ej3 Wiener NS LR tx-skip record handoff to
