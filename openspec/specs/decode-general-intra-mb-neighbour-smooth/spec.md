# decode-general-intra-mb-neighbour-smooth Specification

## Purpose

Capture the completed OpenSpec requirements synchronized for `decode-general-intra-mb-neighbour-smooth`.
