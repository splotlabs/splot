# ac0ej3 CfL Chroma Mode Frontier Specification

## Purpose
Define the fail-closed ac0ej3 Wiener NS loop-restoration frontier that consumes
active CfL chroma mode syntax and CfL alpha syntax before decoded chroma sample
population is supported.

## Requirements

### Requirement: ac0ej3 CfL Chroma Mode Frontier

The decoder SHALL track `DECODE-AC0EJ3-CFL-CHROMA-MODE-FRONTIER` as a partial
runtime prerequisite for the ac0ej3 Wiener NS LR path. When the supported
