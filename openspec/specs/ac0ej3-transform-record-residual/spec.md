# ac0ej3 Transform-Record Residual Specification

## Purpose
Define the fail-closed ac0ej3 Wiener NS LR handoff that consumes supported
...
The decoder SHALL consume the live ac0ej3 Wiener NS LR transform-record
...
- **WHEN** the local `ac0ej3.ivf` stream reaches the active Wiener NS LR
