# decode-general-intra-directional-follow-chroma Specification

## Purpose

Capture the completed OpenSpec requirements synchronized for `decode-general-intra-directional-follow-chroma`.
