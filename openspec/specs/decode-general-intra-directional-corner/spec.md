# decode-general-intra-directional-corner Specification

## Purpose

Capture the completed OpenSpec requirements synchronized for `decode-general-intra-directional-corner`.
