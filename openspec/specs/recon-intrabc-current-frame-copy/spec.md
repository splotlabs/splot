# recon-intrabc-current-frame-copy Specification

## Purpose
Define the checked same-plane current-frame rectangle copy primitive used by
bounded IntrABC handoffs before broader IntrABC prediction is supported.
