# decode-general-intra-directional-neighbour-ctx Specification

## Purpose

Capture the completed OpenSpec requirements synchronized for `decode-general-intra-directional-neighbour-ctx`.
