# decode-general-intra-neighbour-directional Specification

## Purpose

Capture the completed OpenSpec requirements synchronized for `decode-general-intra-neighbour-directional`.
