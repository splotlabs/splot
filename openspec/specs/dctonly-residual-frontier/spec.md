# dctonly-residual-frontier Specification

## Purpose

Track the partial local decoder mission Wiener NS LR residual frontier where selectable
...
#### Scenario: local decoder mission probe records the follow-on frontier
