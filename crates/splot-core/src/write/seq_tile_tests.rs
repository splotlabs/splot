...
// Unit, byte-exact, property, and rejection tests for the § 5.4.10 filter / § 5.4.2 tile
// writers and the composing `write_sequence_header`. `include!`d into
// `crate::write::seq_tile` so `super::*` resolves to its writers and private helpers.
