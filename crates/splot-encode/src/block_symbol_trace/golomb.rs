...
fn compose_intra_dc_golomb_tail_trace(
    negative: bool,
    zero_count: u32,
    coeff_rem_width: u32,
    coeff_rem: u32,
    ...
    trace.push(BlockSymbolToken::bypass(coeff_rem_width, coeff_rem));
...
pub(crate) fn compose_intra_dc_golomb_block_trace(
    ...
    let q = x >> GOLOMB_DC_M;
    let coeff_rem = x & 1;
    compose_intra_dc_golomb_tail_trace(
        negative,
        q,
        1,
        coeff_rem,
        "golomb block trace length",
        "golomb block trace",
    )
}
...
pub(crate) fn compose_intra_dc_golomb_prefix_block_trace(
    ...
    compose_intra_dc_golomb_tail_trace(
        negative,
        GOLOMB_PREFIX_Q_ZEROS + golomb_zeros,
        length,
        coeff_rem,
        "golomb-prefix block trace length",
        "golomb-prefix block trace",
    )
}
