...
//! longer applies). `transform_type()` is the § 5.20.8.2 transform-type syntax,
//! called from § 5.20.7.27 `coeffs()`. Split out of `coefficient_tokenization` to
//! keep the parent file under the 1000-line source budget.
