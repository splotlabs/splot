...
pub(super) fn read_warp_inter_mode_syntax(
...
pub(super) fn read_warp_newmv_motion_mode_syntax(
    cdfs: &mut TileCdfSubset,
    symbols: &mut SymbolDecoder<'_>,
...
pub(super) struct ParsedWarpNewmv {
    pub(super) mv: Mv,
    pub(super) warp_params: [i64; 6],
    pub(super) ref_mv_idx: usize,
    pub(super) ref_warp_idx: usize,
    pub(super) precision_idx: u8,
    pub(super) warpmv_with_mvd: bool,
    pub(super) block_precision: BlockPrecisionRecord,
}

#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub(super) struct WarpInterIntraSyntax {
    pub(super) enabled: bool,
    pub(super) mode: Option<u8>,
    pub(super) use_wedge: bool,
    pub(super) wedge_index: Option<u8>,
}

pub(super) fn inter_mv_read_config(
    core: &FrameHeaderCore,
    tile_offset: ByteOffset,
) -> Result<MvReadConfig> {
    let precision = core
...
pub(super) const fn mv_precision_code(precision: MvPrecision) -> Option<u8> {
...
pub(super) fn inter_mvd_sign_derivation_allowed(
...
#[allow(clippy::too_many_arguments)]
pub(super) fn read_warp_extend_syntax(
    cdfs: &mut TileCdfSubset,
    symbols: &mut SymbolDecoder<'_>,
    sequence: &SequenceHeader,
    core: &FrameHeaderCore,
...
#[allow(clippy::too_many_arguments)]
pub(super) fn read_warp_newmv_delta_syntax(
    cdfs: &mut TileCdfSubset,
    symbols: &mut SymbolDecoder<'_>,
    sequence: &SequenceHeader,
    core: &FrameHeaderCore,
...
#[allow(clippy::too_many_arguments)]
pub(super) fn read_warpmv_delta_syntax(
    cdfs: &mut TileCdfSubset,
    symbols: &mut SymbolDecoder<'_>,
    mv_config: MvReadConfig,
    _b_size: usize,
...
pub(super) fn interintra_prediction_mode(
...
pub(super) fn read_warp_inter_intra_syntax(
    cdfs: &mut TileCdfSubset,
    symbols: &mut SymbolDecoder<'_>,
    b_size: usize,
    n4w: usize,
...
pub(super) fn read_wedge_mode_syntax(
    cdfs: &mut TileCdfSubset,
    symbols: &mut SymbolDecoder<'_>,
    tile_offset: ByteOffset,
) -> Result<u8> {
