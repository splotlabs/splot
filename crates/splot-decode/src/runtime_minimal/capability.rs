...
pub(super) use missing_capability_message;
    ...
    fn compressed_runtime_message_keeps_unsupported_feature_rule() {
        ...
        let error = DecodeError::UnsupportedFeature {
            unsupported: Box::new(DecodeUnsupportedFeature::new(
                ...
                super::super::MINIMAL_INTRA_HASH_TIER_ID,
                super::super::GENERAL_INTRA_MATRIX_ROW,
                super::super::GENERAL_INTRA_FEATURE_ID,
                super::super::GENERAL_INTRA_MODE_SPEC_SECTION,
                message,
                super::super::GENERAL_INTRA_REMEDIATION,
                None,
            )),
        };
