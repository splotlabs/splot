...
use super::{
    ...
    DO_UNEVEN_4WAY_PARTITION_CONTEXTS, RECT_TYPE_CONTEXTS, TileCdfArray, TileCdfError,
    TileCdfSelector, checked_plane,
};
...
mod tests {
    ...
    use splot_core::tables::cdf::{
        DEFAULT_DO_EXT_PARTITION_CDF, DEFAULT_DO_SPLIT_CDF, DEFAULT_DO_UNEVEN_4WAY_PARTITION_CDF,
        DEFAULT_RECT_TYPE_CDF,
    };
