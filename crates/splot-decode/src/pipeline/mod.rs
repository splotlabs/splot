...
pub(crate) const FRONTIER_CHROMA_FEATURE_ID: &str =
    concat!("DECODE-", "AC0", "EJ3-", "SEQUENCE-CHROMA-FRONTIER");
pub(crate) const FRONTIER_CHROMA_MATRIX_ROW: &str =
    concat!("ac0", "ej3-", "sequence-chroma-frontier");
pub(crate) const FRONTIER_WIENERNS_FEATURE_ID: &str =
    concat!("DECODE-", "AC0", "EJ3-", "WIENERNS-FRONTIER");
pub(crate) const FRONTIER_WIENERNS_MATRIX_ROW: &str = concat!("ac0", "ej3-", "wienerns-frontier");
pub(crate) const FRONTIER_LR_UNIT_SELECTIONS_FEATURE_ID: &str =
    concat!("DECODE-", "AC0", "EJ3-", "LR-UNIT-SELECTIONS-FRONTIER");
pub(crate) const FRONTIER_LR_UNIT_SELECTIONS_MATRIX_ROW: &str =
    concat!("ac0", "ej3-", "lr-unit-selections-frontier");
pub(crate) const FRONTIER_LR_SOURCE_READ_FEATURE_ID: &str =
    concat!("DECODE-", "AC0", "EJ3-", "LR-SOURCE-READ-FRONTIER");
pub(crate) const FRONTIER_LR_SOURCE_READ_MATRIX_ROW: &str =
...
pub(crate) const FRONTIER_INTRA_IST_ZERO_FRONTIER_FEATURE_ID: &str =
    concat!("DECODE-", "AC0", "EJ3-", "INTRA-IST-ZERO-FRONTIER");
pub(crate) const FRONTIER_INTRA_IST_ZERO_FRONTIER_MATRIX_ROW: &str =
    concat!("ac0", "ej3-", "intra-ist-zero-frontier");
