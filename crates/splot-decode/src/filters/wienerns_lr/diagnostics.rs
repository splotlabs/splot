...
use crate::pipeline::{
    FRONTIER_DCTONLY_RESIDUAL_FRONTIER_FEATURE_ID, FRONTIER_DCTONLY_RESIDUAL_FRONTIER_MATRIX_ROW,
    FRONTIER_INTRA_IST_ZERO_FRONTIER_FEATURE_ID, FRONTIER_INTRA_IST_ZERO_FRONTIER_MATRIX_ROW,
    FRONTIER_LR_CLASSIFIED_WIENER_STORAGE_FEATURE_ID,
    FRONTIER_LR_CLASSIFIED_WIENER_STORAGE_MATRIX_ROW,
    FRONTIER_LR_LIVE_STORAGE_ALLOCATION_FEATURE_ID, FRONTIER_LR_LIVE_STORAGE_ALLOCATION_MATRIX_ROW,
    ...
    FRONTIER_LR_SOURCE_READ_MATRIX_ROW, FRONTIER_LR_UNIT_SELECTIONS_FEATURE_ID,
    FRONTIER_LR_UNIT_SELECTIONS_MATRIX_ROW, FRONTIER_LUMA_TXTYPE_RESIDUAL_HANDOFF_FEATURE_ID,
    FRONTIER_LUMA_TXTYPE_RESIDUAL_HANDOFF_MATRIX_ROW,
    FRONTIER_SELECTABLE_TRANSFORM_RECORDS_FEATURE_ID,
    FRONTIER_SELECTABLE_TRANSFORM_RECORDS_MATRIX_ROW, unsupported_feature_at,
};
...
pub(crate) fn transform_tool_residual_frontier(
    ...
    match reason {
        ...
        | "unsupported_dctonly_residual_intra_ist_context" => (
            ...
            FRONTIER_INTRA_IST_ZERO_FRONTIER_MATRIX_ROW,
            FRONTIER_INTRA_IST_ZERO_FRONTIER_FEATURE_ID,
            "5.20.7.29",
        ),
        _ => (
            ...
            FRONTIER_DCTONLY_RESIDUAL_FRONTIER_MATRIX_ROW,
            FRONTIER_DCTONLY_RESIDUAL_FRONTIER_FEATURE_ID,
            "5.20.7.27",
        ),
    }
}
...
pub(crate) fn wienerns_lr_unit_runtime_error(offset: ByteOffset) -> DecodeError {
    unsupported_feature_at(
        ...
        FRONTIER_LR_UNIT_SELECTIONS_MATRIX_ROW,
        FRONTIER_LR_UNIT_SELECTIONS_FEATURE_ID,
        "5.20.10.5",
    )
}
...
pub(crate) fn wienerns_lr_live_storage_allocation_error(offset: ByteOffset) -> DecodeError {
    unsupported_feature_at(
        ...
        FRONTIER_LR_LIVE_STORAGE_ALLOCATION_MATRIX_ROW,
        FRONTIER_LR_LIVE_STORAGE_ALLOCATION_FEATURE_ID,
        "7.20.4",
    )
}
...
pub(crate) fn wienerns_lr_selectable_transform_record_error_reason(
    ...
    let (message, matrix_row, feature_id, spec_section) = match reason {
        "unsupported_wienerns_lr_selectable_transform_records_chroma_offset_leaf" => (
            ...
            FRONTIER_LUMA_TXTYPE_RESIDUAL_HANDOFF_MATRIX_ROW,
            FRONTIER_LUMA_TXTYPE_RESIDUAL_HANDOFF_FEATURE_ID,
            "5.20.3.1",
        ),
        "unsupported_wienerns_lr_selectable_transform_records_intrabc" => (
            ...
            FRONTIER_SELECTABLE_TRANSFORM_RECORDS_MATRIX_ROW,
            FRONTIER_SELECTABLE_TRANSFORM_RECORDS_FEATURE_ID,
            "5.20.5.3",
        ),
