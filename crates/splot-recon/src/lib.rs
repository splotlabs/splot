...
pub use workspace::{
    ...
    CurrentFrameRect, CurrentFrameRectRows, CurrentFrameRowBand, CurrentFrameRowBands,
    CurrentFrameSurface, CurrentFrameWorkspace, InterIntraMode, IntraPredictionScratch,
